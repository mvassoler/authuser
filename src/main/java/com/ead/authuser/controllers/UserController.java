...
public class UserController {
    ...
    @Autowired
    public AuthenticationCurrentUserService authenticationCurrentUserService;
    ...
    public ResponseEntity<Object> deleteUser(@PathVariable(value = "userId") UUID userId){
        ...
        log.debug("DELETE deleteUser userDTO deleted {} ", userId);
    ...
    public ResponseEntity<Object> updateUser(@PathVariable(value = "userId") UUID userId,
        ...
        log.info("User updated sucessfully userId {} ", userModel.getUserId());
    ...
    public ResponseEntity<Object> updatePassword(@PathVariable(value = "userId") UUID userId,
        ...
        if(!userModelOptional.get().getPassword().equals(userDTO.getOldPassword())){
            log.warn("Mismateched old password userId {} ", userId.toString());
